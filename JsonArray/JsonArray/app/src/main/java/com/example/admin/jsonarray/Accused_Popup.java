...
public class Accused_Popup extends CursorAdapter {

    public Accused_Popup(Context context, Cursor cursor) {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        return LayoutInflater.from(context).inflate(R.layout.accused_popup, parent, false);
    }
